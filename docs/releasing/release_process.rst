Steps of the nrtk-cdao Release Process
=================================
...
a. Navigate to the GitLab `Releases page`_ for the nrtk-cdao repository.

b. Click the "Create a new release" button (or go `here
   <https://gitlab.jatic.net/jatic/kitware/nrtk-cdao/-/releases/new>`_).
...
.. _Releases page: https://gitlab.jatic.net/jatic/kitware/nrtk-cdao/-/releases
