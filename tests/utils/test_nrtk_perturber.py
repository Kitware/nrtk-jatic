...
if is_usable:
    ...
    def _load_dataset(
        dataset_path: str, load_metadata: bool = True
    ) -> COCOJATICObjectDetectionDataset:
...
class TestNRTKPerturber:
    ...
    def test_nrtk_perturber(
        self, perturber_factory: PerturbImageFactory, img_dirs: List[str]
    ) -> None:
        ...
        augmented_datasets = nrtk_perturber(
            maite_dataset=dataset, perturber_factory=perturber_factory
        )
    ...
    def test_missing_metadata(self) -> None:
        ...
        with pytest.raises(
            ...
            _ = nrtk_perturber(
                maite_dataset=dataset, perturber_factory=self.pybsm_factory
            )
